...
class EmbeddingStore:
    ...
    def __init__(
        ...
        try:
            import chromadb
            self._collection = chromadb.EphemeralClient().get_or_create_collection(name=collection_name)
    ...
    def _search_records(self, query: str, records: list[dict[str, Any]], top_k: int) -> list[dict[str, Any]]:
        ...
        ranked = sorted(records, key=lambda record: compute_similarity(query_embedding, record["embedding"]), reverse=True)
